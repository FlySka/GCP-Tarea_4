...
function loadScene()
{
    ...
    floor = new THREE.Mesh(geometry_floor, material);
    ...
    rectangulo = new THREE.Mesh(geometry,material);
    ...
    cilindro3 = new THREE.Mesh(geometry,material);
    ...
    cilindro4 = new THREE.Mesh(geometry,material);
    ...
    const pinzas_z = 14/2;
    const pinzas_x = 10;
    pinza1 = new THREE.Mesh(geometry,material);
    pinza1.position.y = pinzas_y;
    pinza1.position.z = pinzas_z;
    pinza1.position.x = pinzas_x;
    // scene.add(pinza1);

    pinza2 = new THREE.Mesh(geometry,material);
    ...
    garra1 = new THREE.Mesh(geometry, new THREE.MeshNormalMaterial({side: THREE.DoubleSide}));
    ...
    garra2 = new THREE.Mesh(geometry,new THREE.MeshNormalMaterial({side: THREE.DoubleSide}));
...
function animate_stop(){
    ...
    baseRobot.rotation.y = 0;
    arm.rotation.z = 0;
    pivotPoint2.rotation.z = 0;
    pinza1_1.position.z = -2;
    pinza1_2.position.z = 2;
}
